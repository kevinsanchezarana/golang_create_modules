...
// Comparable: It allows any type whose values may be used as an operand of the comparison operators == and !=
...
// Number Interface constants
// Replacing int64 | float64 by the Number type
